    ...
    return RaisedButton(
      ...
      onPressed: () {
        ...
        if (confirmpasswordController.text
          ...
          postSignupRequest().then((value) {
            print("post request successfull");
            setState(() {
              isloading = false;
            });
          });
          print("calling post requests");
          //Post Method
        } else {
          final snackBar = SnackBar(
              content: Text("Confirm password doesn't match password"));
...
//        height: _height / 20,
  ...
  Future<void> postSignupRequest() async {
    final response = await http.post(
      Uri.https('omnibliss-backend2.herokuapp.com', '/api/accounts/register/'),
